...
const (
	...
	Eth1DataVotesLength                   = 1024          // SLOTS_PER_ETH1_VOTING_PERIOD
	PreviousEpochAttestationsLength       = 2048          // MAX_ATTESTATIONS * SLOTS_PER_EPOCH
	CurrentEpochAttestationsLength        = 2048          // MAX_ATTESTATIONS * SLOTS_PER_EPOCH
